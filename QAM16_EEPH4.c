...
int main() {
    ...
    while (error_block < 100/*100*/) {
        ...
        for(i = 0; i < 4; i++) printf("codaeeray[%d], %d\n", i,codarray[i]);
        printf("%g %g \n", s[0][0],s[0][1]);
        printf("%g %g \n", x_receive[0][0],x_receive[0][1]);
        ...
        for (i = 0; i < Ljlen; i++) {
            ...
            if ((i % 4) == 0) {
                ...
                Lj[i] = 1/pow(sigma , 2) * 0.5  * (- minimum(d1,d2,d3,d4,d5,d6,d7,d8) + minimum(s1,s2,s3,s4,s5,s6,s7,s8));
                ...
                /*d1 = pow((x_receive[i / 4][0] + 3),2) + pow((x_receive[i/4][1] + 3),2);         // X3 = 0
                d2 = pow((x_receive[i / 4][0] + 1),2) + pow((x_receive[i/4][1] + 3),2);
                d3 = pow((x_receive[i / 4][0] - 1),2) + pow((x_receive[i/4][1] + 3),2);
                d4 = pow((x_receive[i / 4][0] - 3),2) + pow((x_receive[i/4][1] + 3),2);
                d5 = pow((x_receive[i / 4][0] + 3),2) + pow((x_receive[i/4][1] + 1),2);
                d6 = pow((x_receive[i / 4][0] + 1),2) + pow((x_receive[i/4][1] + 1),2);
                d7 = pow((x_receive[i / 4][0] - 1),2) + pow((x_receive[i/4][1] + 1),2);
                d8 = pow((x_receive[i / 4][0] - 3),2) + pow((x_receive[i/4][1] + 1),2);*/
                ...
                s8 = pow((x_receive[i / 4][0] - 3),2) + pow((x_receive[i/4][1] - 3),2);
                /*s1 = pow((x_receive[i / 4][0] + 3),2) + pow((x_receive[i/4][1] + 3),2);         // X3 = 1
                s2 = pow((x_receive[i / 4][0] + 1),2) + pow((x_receive[i/4][1] + 3),2);
                s3 = pow((x_receive[i / 4][0] - 1),2) + pow((x_receive[i/4][1] + 3),2);
                s4 = pow((x_receive[i / 4][0] - 3),2) + pow((x_receive[i/4][1] + 3),2);
                s5 = pow((x_receive[i / 4][0] + 3),2) + pow((x_receive[i/4][1] - 3),2);
    ...
    FILE *outfp1; 
        outfp1 = fopen("QAM16_EEPH4_vr1.txt","a");
