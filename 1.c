...
double **s;
int srow = 2000;  // Na / 4 transmitt how many symbols (transmitter)
...
int main() {
    ...
    // OPEN FILE
    FILE *fpr1;
    fpr1=fopen("generator8000.txt","r");
    printf("column = %d\n", n);
    printf("row = %d\n", krc);
    Glenrow = krc;
    Glencolumn = n;
    ...
    FILE *outfp1; 
        outfp1 = fopen("QAM16_EEP_8000_iteration100.txt","a");
